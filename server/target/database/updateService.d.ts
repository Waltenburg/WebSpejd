...
export declare class UpdateService extends ServiceBase {
     ...
     */
    isPatrolUpdateValid(newUpdate: PatrolUpdateWithNoId, includeRouteValidation?: boolean, includeCurrentEqualsTargetCheck?: boolean, isTargetFirstLocation?: boolean, includeNoImmediateIdenticalUpdateCheck?: boolean): boolean;
    /**
