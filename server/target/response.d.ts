...
export declare class Response {
     ...
     */
    static ok(content?: string | Buffer): Response;
    /**
     ...
     * @returns a new response.
     */
    static badRequest(content?: string | Buffer): Response;
    /**
     ...
     * @returns a new response
     */
    static notFound(content?: string | Buffer): Response;
    /**
 ...
 */
export declare function send_response(connection: http.ServerResponse, response: Response): void;
