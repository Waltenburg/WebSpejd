...
export class Response {
     ...
     */
    public static ok(content?: string | Buffer): Response {
     ...
     * @returns a new response.
     */
     public static badRequest(content?: string | Buffer): Response {
     ...
     * @returns a new response
     */
    public static notFound(content?: string | Buffer) {
 ...
 */
export function send_response(connection: http.ServerResponse, response: Response) {
    try{
