...
const fetchGraphData = async () => {
    const response = await fetch("/master/locationRouteGraphData" /* Endpoints.GetLocationRouteGraphData */);
    if (!response.ok) {
...
const saveLayout = async () => {
    ...
    try {
        await fetch("/master/locationRouteGraphLayout" /* Endpoints.SetLocationRouteGraphLayout */, {
            method: 'POST',
            headers: {
...
const initializeNetwork = async (container) => {
...
export {};
//# sourceMappingURL=locationRouteGraph.js.map