class LocationPasswordManager {
    ...
    async fetchPasswords(locationId) {
        try {
            const response = await fetch(`${"/master/getLocationPasswords" /* Endpoints.GetLocationPasswords */}?locationId=${encodeURIComponent(String(locationId))}`);
            if (!response.ok) {
    ...
    async addPassword(password) {
        ...
        try {
            ...
            const response = await fetch("/master/addLocationPassword" /* Endpoints.AddLocationPassword */, {
                method: "POST",
                headers: {
    ...
    async deletePassword(entryId) {
        ...
        try {
            ...
            const response = await fetch("/master/deleteLocationPassword" /* Endpoints.DeleteLocationPassword */, {
                method: "POST",
                headers: {
                    "Content-Type": "application/x-www-form-urlencoded"
                },
