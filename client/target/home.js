...
const onLoadFunction = () => {
    ...
    document.getElementById("loginInMandskab").addEventListener("click", () => location.assign("/mandskab" /* Endpoints.Mandskab */));
    document.getElementById("loginInMaster").addEventListener("click", () => location.assign("/master" /* Endpoints.MainMasterPage */));
...
const loginClicked = (existingUser) => {
    ...
    const loginSucces = (status, headers, _body) => {
